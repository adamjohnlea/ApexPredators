...
struct PredatorRow_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let predator = ApexPredator(id: 3, name: "Tyrannosaurus Res", type: "Land", movies: ["Jurassic Park","The Lost World: Jurassic Park","Jurassic Park III","Jurassic World","Jurassic World: Fallen Kingdom"], movieScenes: [movieScene], link: "https://jurassicpark.fandom.com/wiki/Tyrannosaurus_rex")
